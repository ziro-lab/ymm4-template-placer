...
12. `docs/BEHAVIOR_PREVIEW_DESIGN.md` for the accepted Preview phase
13. `docs/BEHAVIOR_PREVIEW_ACCEPTANCE.md`
14. `docs/BEHAVIOR_PREVIEW_WORKPLAN.md`
