...
Compact Settings friction/discoverability is accepted at exact product/test/package source `05285a7bae1eb59b4b588c565aa46e29bdea795c` by Release #654 (`35897405826`), with **1,822 Native assertions PASS**, exact distribution-DLL smoke and verified `.ymme` / source / provenance packaging. Baseline simplification / compatibility cleanup is complete on main merge `af6a667e401a99311ef58293c750ac51b9145f54`; main Release #708 (`35983059810`) is GREEN with **1,198 Native assertions PASS / 0 FAIL**, exact distribution-DLL smoke and verified `.ymme` / source / provenance packaging. Behavior Preview v2 is owner hands-on accepted at final tested source `6ed136abcb9b6a3346e32d1b0661c5aed98d69b3`; Release #747 is GREEN with **1,254 Native assertions PASS / 0 FAIL**, exact distribution-DLL smoke and verified packaging. The next product phase is a compact YMM4-native Undo/Redo surface, followed by placement quick-settings investigation using the same Settings Draft and accepted Preview. The “what I want” checklist and Full Settings Workspace are deferred for need-based re-evaluation rather than automatic sequencing. Known later items also include Composite/Fan-out placement, stronger Target/Neighbor grammar and measured built-in Tachie Preset loading optimization. Do not reopen completed Portable Settings, Placement Source, bounded Placement Rule, Compact Settings or Behavior Preview architecture while addressing those items.
