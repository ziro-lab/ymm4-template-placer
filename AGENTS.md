...
Compact Settings friction/discoverability is accepted at exact product/test/package source `05285a7bae1eb59b4b588c565aa46e29bdea795c` by Release #654 (`35897405826`), with **1,822 Native assertions PASS**, exact distribution-DLL smoke and verified `.ymme` / source / provenance packaging. Baseline simplification / compatibility cleanup is complete on main merge `af6a667e401a99311ef58293c750ac51b9145f54`; main Release #708 (`35983059810`) is GREEN with **1,198 Native assertions PASS / 0 FAIL**, exact distribution-DLL smoke and verified `.ymme` / source / provenance packaging. Behavior Preview v2 is owner hands-on accepted at final tested source `6ed136abcb9b6a3346e32d1b0661c5aed98d69b3`; Release #747 is GREEN with **1,254 Native assertions PASS / 0 FAIL**, exact distribution-DLL smoke and verified packaging. Compact YMM4-native Undo/Redo is accepted at exact tested source `d12b4057e8d4cd1b79f009804cd280d96c38c148`; Release #760 / run `36068432875` is GREEN with **1,263 ASSERT PASS / 0 FAIL**, exact distribution-DLL smoke and verified packaging. Placement Quick Settings first slice is Release GREEN at exact tested source `9dae643cb9c29780783dde265d41dc4a90f01a62` by Release #770 / run `36076134931`, with **1,277 ASSERT PASS / 0 FAIL**, exact distribution-DLL smoke and verified packaging. P0-P2 are native accepted; P3 owner hands-on is the active next step. The implementation uses the same Settings Draft, existing protected Settings transaction and accepted Preview. Neighbor ambiguity result fan-out is Release GREEN at exact tested source `7615dddfc6b9e7d6f54d8d77b2f65eceb185fffa` by Release #775 / run `36082152950`, with **1,292 ASSERT PASS / 0 FAIL**, exact distribution-DLL smoke and verified packaging. Normal Targeted tile placement now collapses equal final Neighbor results, while multiple distinct results require an exact second execution and then commit atomically as one native Undo; automated strict paths remain single-result. Pre-release lifecycle audit closeout is Release GREEN at exact tested product/test/package source `e03ca525c255532faa1d2865b6b7ad59fc05cf7b` by Release #787 / run `36136152209`, with **1,305 ASSERT PASS / 0 FAIL**, `AUDIT_B01/B02/B08=PASS`, exact distribution-DLL smoke and verified packaging. B08 fault injection reproduced a real post-mutation commit-failure gap; `PlacementPlan` now restores its own exact pre-commit snapshot on commit failure while keeping YMM4 native Undo as the only user history. The “what I want” checklist and Full Settings Workspace are deferred for need-based re-evaluation rather than automatic sequencing. Known later items also include Composite/Fan-out placement, stronger Target/Neighbor grammar and measured built-in Tachie Preset loading optimization. Do not reopen completed Portable Settings, Placement Source, bounded Placement Rule, Compact Settings, Behavior Preview or native Undo/Redo architecture while addressing those items.

Read in this order:

1. `docs/CURRENT_ARCHITECTURE.md`
2. `docs/PRODUCT_ROADMAP.md` for current product sequencing
3. `docs/PLACEMENT_QUICK_SETTINGS_DESIGN.md` for the active quick-settings hands-on phase
4. `docs/PLACEMENT_QUICK_SETTINGS_ACCEPTANCE.md`
5. `docs/PLACEMENT_QUICK_SETTINGS_WORKPLAN.md`
6. `docs/NEIGHBOR_AMBIGUITY_FANOUT_DESIGN.md` for the completed friction correction / pending hands-on
7. `docs/NEIGHBOR_AMBIGUITY_FANOUT_ACCEPTANCE.md`
8. `docs/NEIGHBOR_AMBIGUITY_FANOUT_WORKPLAN.md`
9. `docs/BEHAVIOR_PREVIEW_DESIGN.md` for the accepted Preview phase
...
13. `docs/BASELINE_SIMPLIFICATION_ACCEPTANCE.md`
14. `docs/BASELINE_SIMPLIFICATION_WORKPLAN.md`
15. `docs/COMPACT_SETTINGS_FRICTION_DESIGN.md` for the accepted compact-Settings friction baseline
16. `docs/COMPACT_SETTINGS_FRICTION_ACCEPTANCE.md`
17. `docs/COMPACT_SETTINGS_FRICTION_WORKPLAN.md`
18. `docs/PLACEMENT_RULE_COMPLETION_DESIGN.md` for the accepted bounded placement-rule model
19. `docs/PLACEMENT_RULE_COMPLETION_ACCEPTANCE.md`
20. `docs/PLACEMENT_RULE_COMPLETION_WORKPLAN.md`
21. `docs/PLACEMENT_SOURCE_UNIFICATION_DESIGN.md` for the accepted Source/Placement model
22. `docs/PLACEMENT_SOURCE_UNIFICATION_ACCEPTANCE.md`
23. `docs/PLACEMENT_SOURCE_UNIFICATION_WORKPLAN.md`
24. `docs/GLOSSARY.md`
25. `docs/VALIDATION_STRATEGY.md`
26. `docs/TACHIE_PRESET_DESIGN.md`
27. `docs/TACHIE_PRESET_ACCEPTANCE.md`
28. `docs/EXPRESSION_PERFORMANCE_DESIGN.md`
29. `docs/EXPRESSION_PERFORMANCE_ACCEPTANCE.md`
30. `docs/FINAL_HANDS_ON_POLISH.md`
31. `docs/BACKLOG.md` only for scope/detail
32. `docs/LEGACY_COMPATIBILITY_MAP.md` before deleting/refactoring old-looking code
33. historical Round/W documents only when current authority points to them or when reconstructing rationale
