...
Current roadmap state: **Behavior Preview and native Undo/Redo are accepted; placement quick settings is NEXT.** The “what I want” checklist and Full Settings Workspace are deferred for need-based re-evaluation. Do not use this Backlog to silently reorder those phases.
