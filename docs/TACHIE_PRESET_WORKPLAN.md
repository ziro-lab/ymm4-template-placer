...
- all existing expression performance invariants;
- distinct-Character scan counters;
...
Do not add wall-time thresholds.

## P11 — Release + owner Hands-on

Hands-on focus:

- source-switch discoverability;
- built-in PSD;
- built-in Animation;
- one available real-world third-party/direct-name route;
- rapid source/tab switching;
- repeated same-Voice preset changes;
- Template mode performance/regression;
- ambiguous/missing candidate recovery.

Do not merge until owner accepts.
