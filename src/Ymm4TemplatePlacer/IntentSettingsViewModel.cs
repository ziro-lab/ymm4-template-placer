...
public sealed partial class PlacerViewModel
{
    ...
    public IReadOnlyList<IntentOption<IntentAlignment>> IntentAlignments { get; } = [new(IntentAlignment.StartAtAnchor,"ここから開始"),new(IntentAlignment.CenterAtAnchor,"中央をここに合わせる"),new(IntentAlignment.EndAtAnchor,"ここで終了")];
