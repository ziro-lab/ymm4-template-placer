...
{
    private string name = "", startOffset = "0", endOffset = "0", duration = "30", headPadding = "0", tailPadding = "0", tolerance = "0";
    ...
    public string Tolerance { get => tolerance; set => Set(ref tolerance, value); }
    ...
    public void Load(SelectionPreset preset)
    {
        ...
        HeadPadding = Text(preset.HeadPadding); TailPadding = Text(preset.TailPadding); Tolerance = Text(preset.Tolerance);
