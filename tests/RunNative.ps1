...
if (-not (Select-String -Path $log -Pattern '^LAYER_UX_P0=PASS$')) { throw 'Layer UX P0 source-layer proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^LAYER_UX_P1=PASS$')) { throw 'Layer UX P1 quick-settings proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^LAYER_UX_P2=PASS$')) { throw 'Layer UX P2 Generic-direction proof is incomplete' }
