...
if (-not (Select-String -Path $log -Pattern '^PLACEMENT_SOURCE_P7=PASS$')) { throw 'Placement Source P7 proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^PLACEMENT_RULE_P1=PASS$')) { throw 'Placement Rule P1 proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^PLACEMENT_RULE_P2=PASS$')) { throw 'Placement Rule P2 proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^PLACEMENT_RULE_P3=PASSif (-not (Select-String -Path $log -Pattern '^BEHAVIOR_PREVIEW_P0=PASS$')) { throw 'Behavior Preview P0 description projection proof is incomplete' }
...
# Validate the current workflow contract by schema + named native invariants, not a historical check count.
...
)) { throw 'Placement Rule P3 proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^LAYER_UX_P0=PASSif (-not (Select-String -Path $log -Pattern '^BEHAVIOR_PREVIEW_P0=PASS$')) { throw 'Behavior Preview P0 description projection proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^BEHAVIOR_PREVIEW_P1=PASS$')) { throw 'Behavior Preview P1 read-only schematic proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^NATIVE_UNDO_REDO_P0=PASS$')) { throw 'Native Undo/Redo P0 command surface proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^PLACEMENT_QUICK_SETTINGS_P0=PASS$')) { throw 'Placement Quick Settings P0 shared-draft proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^PLACEMENT_QUICK_SETTINGS_P1=PASS$')) { throw 'Placement Quick Settings P1 finite-action proof is incomplete' }
...
Write-Host 'Checkpoint native validation: full semantic regression and evidence guards PASS'
)) { throw 'Layer UX P0 source-layer proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^LAYER_UX_P1=PASSif (-not (Select-String -Path $log -Pattern '^BEHAVIOR_PREVIEW_P0=PASS$')) { throw 'Behavior Preview P0 description projection proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^BEHAVIOR_PREVIEW_P1=PASS$')) { throw 'Behavior Preview P1 read-only schematic proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^NATIVE_UNDO_REDO_P0=PASS$')) { throw 'Native Undo/Redo P0 command surface proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^PLACEMENT_QUICK_SETTINGS_P0=PASS$')) { throw 'Placement Quick Settings P0 shared-draft proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^PLACEMENT_QUICK_SETTINGS_P1=PASS$')) { throw 'Placement Quick Settings P1 finite-action proof is incomplete' }
...
Write-Host 'Checkpoint native validation: full semantic regression and evidence guards PASS'
)) { throw 'Layer UX P1 quick-settings proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^LAYER_UX_P2=PASSif (-not (Select-String -Path $log -Pattern '^BEHAVIOR_PREVIEW_P0=PASS$')) { throw 'Behavior Preview P0 description projection proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^BEHAVIOR_PREVIEW_P1=PASS$')) { throw 'Behavior Preview P1 read-only schematic proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^NATIVE_UNDO_REDO_P0=PASS$')) { throw 'Native Undo/Redo P0 command surface proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^PLACEMENT_QUICK_SETTINGS_P0=PASS$')) { throw 'Placement Quick Settings P0 shared-draft proof is incomplete' }
if (-not (Select-String -Path $log -Pattern '^PLACEMENT_QUICK_SETTINGS_P1=PASS$')) { throw 'Placement Quick Settings P1 finite-action proof is incomplete' }
...
Write-Host 'Checkpoint native validation: full semantic regression and evidence guards PASS'
)) { throw 'Layer UX P2 Generic-direction proof is incomplete' }
