...
} elseif ($env:GITHUB_EVENT_NAME -eq 'push' -and $env:GITHUB_REF -in @('refs/heads/main','refs/heads/work/v0.4-native-validation','refs/heads/work/v0.5-native-validation')) {
 $level='release'
