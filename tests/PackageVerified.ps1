...
if ($guard.result -cne 'PASS' -or $guard.positive_checks -ne 1 -or $guard.negative_checks -ne 14 -or @($guard.checks | Where-Object { $_.result -cne 'PASS_REJECTED' }).Count) { throw 'Relative evidence guard self-test is incomplete' }
...
$stages=@('P1','P2','P3','P4','P5','P6','P7','P8','P9','W3','W4','W5','W6','W7','W8','W9','W10','W11','W12_UI','W12_SELECTORS','W12','V04') + (1..13 | ForEach-Object { "WUX$_" }) + @('UX_ACCEPTANCE','UX_WORKFLOW_ACCEPTANCE','TEMPLATE_FIDELITY')
...
[ordered]@{
 result='PASS'; version=$version; native_stages='P1-P9,W3-W12,V04,WUX1-WUX13,R1-R14,TEMPLATE_FIDELITY,RELATIVE_UIUX,V042_ACCEPTANCE'; acceptance_requirements=18
