...
internal static partial class NativeProof
{
    private static void VerifyFinalAcceptance()
    {
        ...
        Assert(typeof(PlacerViewModel).Assembly.GetName().Version == new Version(0, 4, 2, 0), "W12 native plugin assembly is version 0.4.2.0");
        ...
        {
            schema = "YMM4-Template-Placer-Acceptance/1", version = "0.4.2", result = "PASS",
